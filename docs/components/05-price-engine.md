...
- **equities source** → stocks, including Turkish (BIST) equities, and the
  continuously-traded classes quoted on the same feed (crypto, tokenized gold).
- **Turkish-fund source** → Turkish mutual / money-market funds (locally
